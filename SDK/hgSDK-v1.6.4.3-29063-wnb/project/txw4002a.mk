...
LinkOtherFlagsOption   :=-Wl,-zmax-page-size=1024 -Wl,--ckmap=$(ProjectPath)/Lst/$(OutputFile).map 
IncludePackagePath     :=
...
CXXFLAGS :=-mcpu=ck803   $(PreprocessorSwitch)__NO_BOARD_INIT  $(PreprocessorSwitch)TXW4002ACK803  $(PreprocessorSwitch)SKB_POOL_ENABLE  $(PreprocessorSwitch)MPOOL_ALLOC  -Os  -g  -Wall -ffunction-sections -fdata-sections -Wno-comment -Wno-unused-function -Wno-unused-but-set-variable -pipe 
CFLAGS   :=-mcpu=ck803   $(PreprocessorSwitch)__NO_BOARD_INIT  $(PreprocessorSwitch)TXW4002ACK803  $(PreprocessorSwitch)SKB_POOL_ENABLE  $(PreprocessorSwitch)MPOOL_ALLOC  -Os  -g  -Wall -ffunction-sections -fdata-sections -Wno-comment -Wno-unused-function -Wno-unused-but-set-variable -pipe 
ASFLAGS  :=-mcpu=ck803   $(PreprocessorSwitch)__NO_BOARD_INIT  $(PreprocessorSwitch)TXW4002ACK803   -Wa,-gdwarf-2 -pipe 
PreprocessFlags  :=-mcpu=ck803   $(PreprocessorSwitch)__NO_BOARD_INIT  $(PreprocessorSwitch)TXW4002ACK803  $(PreprocessorSwitch)SKB_POOL_ENABLE  $(PreprocessorSwitch)MPOOL_ALLOC  -Os  -g  -Wall -ffunction-sections -fdata-sections -Wno-comment -Wno-unused-function -Wno-unused-but-set-variable -pipe 
...
$(IntermediateDirectory)/$(OutputFile):  $(Objects) Always_Link 
	...
	@txw4002a.modify.bat $(IntermediateDirectory) $(OutputFile)$(ExeSuffix) 
