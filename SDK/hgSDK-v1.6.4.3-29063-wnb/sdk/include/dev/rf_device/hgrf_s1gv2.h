...
// @file    hgrf_s1gv2.h
// @author  wangying
// @brief   This file contains all the tx4001 RFIP driver definitions.
// Revision History
// V1.0.0  01-29-2019 First Release
// V1.0.1  06-05-2019 change file name from ahrf_1gv2 to hgrf_s1gv2
// V1.3.0  10-15-2019 add tdma2_dev element

#ifndef __HGRF_S1GV2_H__
#define __HGRF_S1GV2_H__
...
int32 hgrf_s1gv2_attach(uint32 dev_id, struct hgrf_s1gv2 *rfip);
